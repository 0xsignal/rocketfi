                  ...
                  <div className="flex items-center gap-1">
                    ...
                    <Tooltip>
                      ...
                      <TooltipContent className="select-none rounded-xl bg-white px-2 py-1.5 text-xs text-[#272E35] leading-relaxed w-[200px]">
                        <p>
                          The Annual Percentage Rate (APR) represents the interest earned for supplying assets to the protocol, excluding the effects of compounding. .
                        </p>
                      </TooltipContent>
                    </Tooltip>
                  </div>
                ...
                <TableHead className="text-[#6B7280] text-xs font-medium">
                  <div className="flex items-center gap-1">
                    ...
                    <Tooltip>
                      ...
                      <TooltipContent className="select-none rounded-xl bg-white px-2 py-1.5 text-xs text-[#272E35] leading-relaxed w-[200px]">
                        <p>
                          The Annual Percentage Rate (APR) represents the interest rate paid for borrowing assets from the protocol, excluding the effects of compounding. .
                        </p>
                      </TooltipContent>
                    </Tooltip>
                  </div>
