...
const lendingMarkets = [
  { id: 1, name: "Aave", tvl: 5.2, chain:"Ethereum", apy: 3.8, token: "ETH/RPL", detailsUrl:"https://app.aave.com/reserve-overview/?underlyingAsset=0xae78736cd615f374d3085123a210448e74fc6393&marketName=proto_mainnet_v3"},
